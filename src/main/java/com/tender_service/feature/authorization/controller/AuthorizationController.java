...
public class AuthorizationController {
    ...
    public ResponseEntity<?> login(
        ...
        return authorizationService.login(username, email, password);
    }

    @Operation(summary = "Create a new user", description = "Adds a new user to the database, return jwt token")
    @PostMapping
